                ...
                <div className="relative z-10">
                  ...
                  <div className="flex space-x-4">
                    <motion.a
                      ...
                      className="group relative p-4 rounded-full bg-gradient-to-br from-muted to-muted/50 hover:from-primary hover:to-primary/80 transition-all duration-300 shadow-medium hover:shadow-strong"
                    >
                      <Github size={24} className="group-hover:text-primary-foreground transition-colors duration-300" />
                      <motion.div
                    ...
                    <motion.a
                      ...
                      className="group relative p-4 rounded-full bg-gradient-to-br from-muted to-muted/50 hover:from-primary hover:to-primary/80 transition-all duration-300 shadow-medium hover:shadow-strong"
                    >
                      <Linkedin size={24} className="group-hover:text-primary-foreground transition-colors duration-300" />
                      <motion.div
                        className="absolute inset-0 rounded-full bg-gradient-to-r from-transparent via-white/20 to-transparent"
                        initial={{ x: '-100%' }}
                        whileHover={{ x: '100%' }}
                    ...
                    <motion.a
                      ...
                      className="group relative p-4 rounded-full bg-gradient-to-br from-muted to-muted/50 hover:from-primary hover:to-primary/80 transition-all duration-300 shadow-medium hover:shadow-strong"
                    >
                      <Instagram size={24} className="group-hover:text-primary-foreground transition-colors duration-300" />
                      <motion.div
                        className="absolute inset-0 rounded-full bg-gradient-to-r from-transparent via-white/20 to-transparent"
                        initial={{ x: '-100%' }}
                        whileHover={{ x: '100%' }}
